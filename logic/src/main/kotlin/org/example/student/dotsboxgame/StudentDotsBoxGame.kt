...
class StudentDotsBoxGame(columns: Int, rows: Int, players: List<Player>) : AbstractDotsAndBoxesGame() {
    override val players: List<Player> = players  //  ("You will need to get players from your constructor")

    override val currentPlayer: Player get()= currentPlayer  //  ("Determine the current player, like keeping
